...
public abstract class FeaturePagerIconicActivity extends AppCompatActivity {
    ...
    final protected void onCreate(Bundle savedInstanceState) {
        ...
        pager.setAdapter(featurePagerAdapter);
    ...
    /**
     * Set a custom {@link IndicatorControllerInterface} to use a custom indicator view for the {@link FeaturePagerIconicActivity} instead of the
     * default one.
     *
